...
function print_menu2($key, $no)
{
    ...
    for($i=1; $i<count($menu[$key]); $i++)
    {
        ...
        if($menu[$key][$i][1] == "상품유형관리(생협)")
            $str .= '<li class="gnb_2dli"><a href="'.$menu[$key][$i][2].'" class="gnb_2da '.$gnb_grp_style.' '.$gnb_grp_div.'">상품유형관리(산부인과몰)</a></li>';
        else
...
?>
<link type="text/css" href="<?=G5_CSS_URL?>/bootstrap.css" rel="stylesheet" >
<link type="text/javascript" href="<?=G5_JS_URL?>/bootstrap.min.js">
...
<header id="hd">
    <div id="hd_wrap">
        ...
        <ul id="tnb">
            ...
            <li><a href="http://shop.keymedi.com/">키메디 몰</a></li>
			<li><a href="http://obgys.keymedi.com/">산부인과 몰</a></li>
			<li><a href="http://shop.kacsmall.com/">한피성 몰</a></li>
            <?php } ?>
...
foreach($menu['menu'.$menu_key] as $key=>$value) {
    if($key > 0) {
        ...
        if($value[1] == "상품유형관리(생협)")
            echo $nl.'<li><a href="'.$value[2].'"'.$svc_class.'>상품유형관리(산부인과몰)</a></li>';
        else
