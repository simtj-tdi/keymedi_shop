...
$menu['menu200'] = array (
	...
	array('200200', '공급사관리', G5_ADMIN_URL.'/member_list2.php', 'mb_list'),
    ...
    array('200400', '마일리지관리', G5_ADMIN_URL.'/point_list.php', 'mb_point'),
    array('200900', '투표관리', G5_ADMIN_URL.'/poll_list.php', 'mb_poll'),
	array('200910', '회원 등급제 관리', G5_ADMIN_URL.'/member_level.php', 'mb_poll'),
);
?>