...
$menu['menu400'] = array (
	...
	array('400300', '마스터상품관리', G5_ADMIN_URL.'/shop_admin/itemlist.php', 'scf_item'),
	array('400310', '셀러상품관리', G5_ADMIN_URL.'/shop_admin/itemlist2.php', 'scf_item'),
    ...
    array('400610', '상품유형관리(생협)', G5_ADMIN_URL.'/shop_admin/itemtypelist.php', 'scf_item_type'),
	array('400610', '상품유형관리(키메디)', G5_ADMIN_URL.'/shop_admin/itemtypelist2.php', 'scf_item_type'),
	...
	array('400810', '오프라인쿠폰', G5_ADMIN_URL.'/shop_admin/coupon_list.php', 'scf_coupon_zone'),
