...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" width="5%"><?php echo subject_sort_link('a.gr_id') ?>그룹</a></th>
        <th scope="col" width="5%"><?php echo subject_sort_link('bo_table') ?>TABLE</a></th>
        <th scope="col" width="5%"><?php echo subject_sort_link('bo_skin', '', 'desc') ?>스킨</a></th>
        <th scope="col" width="5%"><?php echo subject_sort_link('bo_mobile_skin', '', 'desc') ?>모바일<br>스킨</span></a></th>
        <th scope="col"><?php echo subject_sort_link('bo_subject') ?>제목</a></th>
        <th scope="col" width="3%">읽기P<span class="sound_only">포인트</span></th>
        <th scope="col" width="3%">쓰기P<span class="sound_only">포인트</span></th>
        <th scope="col" width="3%">댓글P<span class="sound_only">포인트</span></th>
        <th scope="col" width="3%">다운P<span class="sound_only">포인트</span></th>
        <th scope="col" width="2%"><?php echo subject_sort_link('bo_use_sns') ?>SNS<br>사용</a></th>
        <th scope="col" width="2%"><?php echo subject_sort_link('bo_use_search') ?>검색<br>사용</a></th>
        <th scope="col" width="3%"><?php echo subject_sort_link('bo_order') ?>출력<br>순서</a></th>
        <th scope="col" width="2%">접속기기</th>
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        $one_update = '<a href="./board_form.php?w=u&amp;bo_table='.$row['bo_table'].'&amp;'.$qstr.'" class="btn btn-primary btn-xs">수정</a>';
        $one_copy = '<a href="./board_copy.php?bo_table='.$row['bo_table'].'" class="btn btn-warning btn-xs" target="win_board_copy">복사</a>';
