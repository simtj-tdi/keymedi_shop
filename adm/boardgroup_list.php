...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" width="5%"><?php echo subject_sort_link('gr_id') ?>그룹아이디</a></th>
        <th scope="col"><?php echo subject_sort_link('gr_subject') ?>제목</a></th>
        <th scope="col" width="5%"><?php echo subject_sort_link('gr_admin') ?>그룹관리자</a></th>
        <th scope="col" width="3%">게시판</th>
        <th scope="col" width="3%">접근사용</th>
        <th scope="col" width="3%">접근회원수</th>
        <th scope="col" width="3%"><?php echo subject_sort_link('gr_order') ?>출력순서</a></th>
        <th scope="col" width="3%">접속기기</th>
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++)
    {
        ...
        $s_upd = '<a href="./boardgroup_form.php?'.$qstr.'&amp;w=u&amp;gr_id='.$row['gr_id'].'" class="btn btn-primary btn-xs">수정</a>';
