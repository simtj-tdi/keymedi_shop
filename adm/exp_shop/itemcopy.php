...
<div class="new_win">
    ...
    <div id="sit_copy">
        <label for="new_it_id">사이트구분 </label>
...
function _copy(link)
{
    ...
    if(it_stock_qty.length > 0) {
	 ...
	 var new_site_code = document.getElementById('site_code').value;
	...
	opener.parent.location.href = encodeURI(link+"&new_it_id="+new_it_id+"&new_it_9="+new_it_9+"&new_it_price="+new_it_price+"&new_it_stock_qty="+new_it_stock_qty+"&token="+token+"&site_code="+new_site_code);
    self.close();
}
// ]]>
</script>
