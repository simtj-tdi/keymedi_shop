...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
        ...
        <td><input type="text" name="mb_17" value="<?php echo $mb['mb_17'] ?>" id="mb_17" class="frm_input" size="15" maxlength="20"></td>
	...
	<tr>
        ...
        <td colspan="3" class="td_addr_line">
            ...
            <input type="text" name="mb_5" value="<?php echo $mb['mb_5'] ?>" id="mb_5" class="frm_input readonly" size="5" maxlength="6"> <br>
    ...
    <tr>
        ...
        <td colspan="3" class="td_addr_line">
            ...
            <input type="text" name="mb_zip" value="<?php echo $mb['mb_zip1'].$mb['mb_zip2']; ?>" id="mb_zip" class="frm_input readonly" size="5" maxlength="6"><br>
