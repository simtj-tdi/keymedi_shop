...
<input type="hidden" name="site_code" value="<?=$fm['site_code']?>">
<div class="tbl_frm01 tbl_wrap">
    ...
    <tbody>
	<tr>
        <th scope="row"><label for="fm_order">사이트코드</label></th>
        <td>
			...
			?>
				<input type="checkbox" name="items[]" value="<?=$row_site[code]?>" <?=(ck_input($row_site[code],$fm['site_code']))?"checked":""?>/> <?=$row_site[code_name]?>&nbsp;&nbsp;&nbsp;&nbsp; 
			<? } ?> 
        </td>
    </tr>
    <tr>
