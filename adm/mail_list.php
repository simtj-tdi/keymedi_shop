...
<div class="tbl_head01 tbl_wrap">
    ...
    <thead>
    <tr>
        <th scope="col" width="2%"><input type="checkbox" name="chkall" value="1" id="chkall" title="현재 페이지 목록 전체선택" onclick="check_all(this.form)"></th>
        <th scope="col" width="3%">번호</th>
        <th scope="col">제목</th>
        <th scope="col" width="8%">작성일시</th>
        <th scope="col" width="4%">테스트</th>
        <th scope="col" width="4%">보내기</th>
        <th scope="col" width="4%">미리보기</th>
    </tr>
    </thead>
    <tbody>
    <?php
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        $s_vie = '<a href="./mail_preview.php?ma_id='.$row['ma_id'].'" target="_blank" class="btn btn-dark btn-xs">미리보기</a>';
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_test"><a href="./mail_test.php?ma_id=<?php echo $row['ma_id'] ?>" class="btn btn-warning btn-xs">테스트</a></td>
        <td class="td_send"><a href="./mail_select_form.php?ma_id=<?php echo $row['ma_id'] ?>" class="btn btn-info btn-xs">보내기</a></td>
