...
// 정보 공개
$mb_24_yes        =  $mb['mb_24'] == "Y"      ? 'checked="checked"' : '';
$mb_24_no         =  $mb['mb_24'] == "N"      ? 'checked="checked"' : '';
$mb_25_yes        =  $mb['mb_25']       ? 'checked="checked"' : '';
$mb_26_yes        =  $mb['mb_26']       ? 'checked="checked"' : '';
...
<input type="hidden" name="return_url" value="member_form2.php">
<input type="hidden" name="mb_shop" value="2">
<input type="hidden" name="mb_v" value="4">
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row"><label for="mb_name">공급사코드<strong class="sound_only">필수</strong></label></th>
        ...
        <th scope="row"><label for="mb_nick">업체명<strong class="sound_only">필수</strong></label></th>
	...
	<tr>
        <th scope="row"><label for="mb_1">사업자등록번호<strong class="sound_only">필수</strong></label></th>
        <td><input type="text" name="mb_1" value="<?php echo $mb['mb_1'] ?>" id="mb_1" required class="required frm_input" size="15" minlength="2" maxlength="20"></td>
	...
	<tr>       
        <th scope="row"><label for="mb_tel">업체전화번호</label></th>
        <td><input type="text" name="mb_tel" value="<?php echo $mb['mb_tel'] ?>" id="mb_tel" class="frm_input required" required size="15" maxlength="20"></td>
		<th scope="row"><label for="mb_2">업체팩스번호</label></th>
        <td><input type="text" name="mb_2" value="<?php echo $mb['mb_2'] ?>" id="mb_2" class="frm_input" size="15" maxlength="20"></td>
    </tr>
	<tr>       
        <th scope="row"><label for="mb_3">담당자명</label></th>
        <td><input type="text" name="mb_3" value="<?php echo $mb['mb_3'] ?>" id="mb_3" class="frm_input required" required size="15" maxlength="20"></td>
		<th scope="row"><label for="mb_hp">담당자SMS</label></th>
        <td><input type="text" name="mb_hp" value="<?php echo $mb['mb_hp'] ?>" id="mb_hp" class="frm_input required" required size="15" maxlength="20"></td>
    </tr>
	<tr>       
        <th scope="row"><label for="mb_4">대표자명</label></th>
        <td><input type="text" name="mb_4" value="<?php echo $mb['mb_4'] ?>" id="mb_4" class="frm_input required" required size="15" maxlength="20"></td>
		<th scope="row"><label for="mb_5">업체이니셜</label></th>
        <td><input type="text" name="mb_5" value="<?php echo $mb['mb_5'] ?>" id="mb_5" class="frm_input required" required size="15" maxlength="20"></td>
    </tr>
	<tr>       
        <th scope="row"><label for="mb_6">업종</label></th>
        <td><input type="text" name="mb_6" value="<?php echo $mb['mb_6'] ?>" id="mb_6" class="frm_input required" required size="15" maxlength="20"></td>
		<th scope="row"><label for="mb_7">취급품</label></th>
        <td><input type="text" name="mb_7" value="<?php echo $mb['mb_7'] ?>" id="mb_7" class="frm_input required" required size="15" maxlength="20"></td>
    </tr>
	<tr>       
        <th scope="row"><label for="mb_8">은행명</label></th>
        <td><input type="text" name="mb_8" value="<?php echo $mb['mb_8'] ?>" id="mb_8" class="frm_input required" required size="15" maxlength="20"></td>
		<th scope="row"><label for="mb_9">예금주</label></th>
        <td><input type="text" name="mb_9" value="<?php echo $mb['mb_9'] ?>" id="mb_9" class="frm_input required" required size="15" maxlength="20"></td>
    </tr>
	<tr>       
        <th scope="row"><label for="mb_10">계좌번호</label></th>
        <td><input type="text" name="mb_10" value="<?php echo $mb['mb_10'] ?>" id="mb_10" class="frm_input required" required size="15" maxlength="20"></td>
		<th scope="row"><label for="mb_homepage">세금계산서 이메일</label></th>
        <td><input type="text" name="mb_homepage" value="<?php echo $mb['mb_homepage'] ?>" id="mb_homepage" class="frm_input required" required size="30" maxlength="50"></td>
    </tr>
	
	<tr>       
        <th scope="row"><label for="mb_11">무료배송금액</label></th>
        <td><input type="text" name="mb_11" value="<?php echo $mb['mb_11'] ?>" id="mb_11" class="frm_input required" required size="15" maxlength="20"></td>
		<th scope="row"><label for="mb_12">택배비</label></th>
        <td><input type="text" name="mb_12" value="<?php echo $mb['mb_12'] ?>" id="mb_12" class="frm_input required" required size="15" maxlength="20"></td>
    </tr>
	<tr>       
        <th scope="row"><label for="mb_14">배송비추가설정</label></th>
        <td><input type="checkbox" name="mb_14" value="1" <?=($mb["mb_14"] == "1")?"checked":""?>> 제주도</td>

		<th scope="row"><label for="mb_15">제주도택배비</label></th>
	...
	<tr>
        ...
        <td >
            ...
            if (file_exists($icon_file)) {
                ...
                echo '<img src="'.$icon_url.'" width="400" alt="">';
                echo '<input type="checkbox" id="del_mb_icon" name="del_mb_icon" value="1">삭제';
            }
            ?>
        </td>
		<th scope="row"><label for="mb_13">업체 구분</label></th>
        <td>
			<input type="radio" name="mb_13" value="1" <?=($mb[mb_13]=="1")?"checked":""?> required/> 의약품&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="mb_13" value="2" <?=($mb[mb_13]=="2")?"checked":""?> required/> 화장품/건식기&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="mb_13" value="3" <?=($mb[mb_13]=="3")?"checked":""?> required/> 의료기기/장비&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="mb_13" value="4" <?=($mb[mb_13]=="4")?"checked":""?> required/> 소모품
		</td>
    </tr>
	<tr>
        <th scope="row"><label for="mb_signature">노출위치</label></th>
		<td>
		<?
			$ckck = explode("|",$mb[mb_28]);
		?>
			<input type="hidden" name="mb_28" value="<?=$mb[mb_28]?>">
			<input type="checkbox" name="item[]" value="shop" <?=($ckck[0] == "shop" || $ckck[1] == "shop" )?"checked":""?> > 산부+몰 &nbsp;&nbsp;&nbsp;&nbsp; 
			<input type="checkbox" name="item[]" value="skin" <?=($ckck[0] == "skin" || $ckck[1] == "skin" )?"checked":""?> > 피부비만 &nbsp;&nbsp;&nbsp;&nbsp;
		</td>
		<th scope="row"><label for="mb_signature">수수료</label></th>
		<td><input type="text" name="mb_27" value="<?php echo $mb['mb_27'] ?>" id="mb_27" class="frm_input "  size="15" maxlength="20">%</td>
	 </tr>
	<tr>
        <th scope="row"><label for="mb_signature">배송정보</label></th>
        <td colspan="3"><textarea  name="mb_signature" id="mb_signature"><?php echo $mb['mb_signature'] ?></textarea></td>
    </tr>
    <tr>
        <th scope="row"><label for="mb_profile">교환/반품</label></th>
	...
	<tr>
        <th scope="row">주문알람 서비스</th>
        <td>
            <input type="radio" name="mb_24" value="Y" id="mb_24_yes" <?php echo $mb_24_yes; ?>>
            <label for="mb_24_yes">예</label>
            <input type="radio" name="mb_24" value="N" id="mb_24_no" <?php echo $mb_24_no; ?>>
            <label for="mb_24_no">아니오</label>
        </td>
        <th scope="row"><label for="mb_25_yes">서비스 종류</label></th>
        <td>
            <input type="checkbox" name="mb_25" value="SMS" id="mb_25_yes" <?php echo $mb_25_yes; ?>>
            <label for="mb_sms_yes">SMS 발송</label>
            <input type="checkbox" name="mb_26" value="EMAIL" id="mb_26_yes" <?php echo $mb_26_yes; ?>>
            <label for="mb_26_yes">E-mail 발송</label>
        </td>
    </tr>
...
this.form.mb_intercept_date.value=this.form.mb_intercept_date.defaultValue; }">
            <label for="mb_intercept_date_set_today">폐업일을 오늘로 지정</label>
        </td>
    </tr>
...
<div class="btn_confirm01 btn_confirm">
    ...
    <a href="./member_list2.php?<?php echo $qstr ?>">목록</a>
</div>
</form>
