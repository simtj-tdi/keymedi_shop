...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            <?php echo help("생협몰 과 메디몰에 표시될 것인지를 설정합니다."); ?>
            <select name="nw_division" id="nw_division">
                <option value="both"<?php echo get_selected($nw['nw_division'], 'both', true); ?>>산부인과몰과 메디몰</option>
                <option value="comm"<?php echo get_selected($nw['nw_division'], 'comm'); ?>>메디몰</option>
                <option value="shop"<?php echo get_selected($nw['nw_division'], 'shop'); ?>>산부인과몰</option>
				<option value="skin"<?php echo get_selected($nw['nw_division'], 'skin'); ?>>피부비만</option>
            </select>
        </td>
    </tr>
    <tr>
	...
	<tr>
        <th scope="row"><label for="nw_ids">팝업 회원지정<strong class="sound_only"> 필수</strong></label></th>
        <td>
            <input type="text" name="nw_ids" value="<?php echo $nw['nw_ids'] ?>" id="nw_ids"  class="frm_input " size="150"><br>
			예시 ) test&&admin&&jun2ys&&  예시2) 하나의 아이디만 넣어도 test&& 이렇게 해주세요
        </td>
    </tr>
    <tr>
