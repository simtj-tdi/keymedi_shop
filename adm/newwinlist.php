...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col">제목</th>
        <th scope="col" width="4%">접속기기</th>
        <th scope="col" width="8%">시작일시</th>
        <th scope="col" width="8%">종료일시</th>
        <th scope="col" width="4%">시간</th>
        <th scope="col" width="4%">Left</th>
        <th scope="col" width="4%">Top</th>
        <th scope="col" width="4%">Width</th>
        <th scope="col" width="4%">Height</th>
        <th scope="col" width="6%">관리</th>
    </tr>
    </thead>
    <tbody>
    <?php
    for ($i=0; $row=sql_fetch_array($result); $i++) {
		...
		switch($row['nw_division']) {
			...
			case 'skin':
                ...
                break;
            default:
                $nw_division = '산부인과몰과 메디몰';
                break;
        }
    ?>
    <tr class="<?php echo $bg; ?>">
        <td class="td_num"><?php echo $row['nw_id']; ?></td>
		<td class="td_datetime"><?php echo $nw_division; ?></td>
        ...
        <td class="td_mngsmall">
            <a href="./newwinform.php?w=u&amp;nw_id=<?php echo $row['nw_id']; ?>" class="btn btn-primary btn-xs"><span class="sound_only"><?php echo $row['nw_subject']; ?> </span>수정</a>
            <a href="./newwinformupdate.php?w=d&amp;nw_id=<?php echo $row['nw_id']; ?>" onclick="return delete_confirm(this);" class="btn btn-danger btn-xs"><span class="sound_only"><?php echo $row['nw_subject']; ?> </span>삭제</a>
        </td>
    </tr>
    <?php
    }
