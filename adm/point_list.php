...
<div class="btn_add01 btn_add">
	<a href="./pointexcel.php" onclick="return excelform(this.href);" target="_blank">포인트일괄지급</a> 
	<a href="#" onclick="down_excel('./point_excel.php');" id="member_add">엑셀다운</a>
</div>
<?php } ?>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" width="8%"><?php echo subject_sort_link('mb_id') ?>회원아이디</a></th>
        <th scope="col" width="8%">이름</th>
        <th scope="col" width="8%">닉네임</th>
        <th scope="col"><?php echo subject_sort_link('po_content') ?>포인트 내용</a></th>
        <th scope="col" width="3%"><?php echo subject_sort_link('po_point') ?>포인트</a></th>
        <th scope="col" width="8%"><?php echo subject_sort_link('po_datetime') ?>일시</a></th>
        <th scope="col" width="5%">만료일</th>
        <th scope="col" width="5%">포인트합</th>
    </tr>
    </thead>
    <tbody>
    <?php
...
function down_excel(src){
	...
	document.fsearch.action = "./point_list.php";
}
</script>
