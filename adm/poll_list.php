...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col">제목</th>
        <th scope="col" width="3%">투표권한</th>
        <th scope="col" width="3%">투표수</th>
        <th scope="col" width="3%">기타의견</th>
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        $s_mod = '<a href="./poll_form.php?'.$qstr.'&amp;w=u&amp;po_id='.$row['po_id'].'" class="btn btn-primary btn-xs">수정</a>';
