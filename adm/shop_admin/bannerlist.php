...
$_search_start_date = $sdate != '' ? $sdate : '' ;
$_search_end_date = $edate != '' ? $edate : '' ;
...
<form name="fsearch" id="fsearch" class="local_sch01 local_sch" method="get" onsubmit="return search_chk(this);">
    ...
    <select name="date_kind" id="date_kind">
        <option value="">전체</option>
        <option value="bn_time" <?php echo get_selected($date_kind, "bn_time", true); ?>>등록일</option>
        <option value="bn_begin_time" <?php echo get_selected($date_kind, "bn_begin_time", true); ?>>시작일</option>
        <option value="bn_end_time" <?php echo get_selected($date_kind, "bn_end_time", true); ?>>종료일</option>
    </select>
    &nbsp;&nbsp;
    기간 : <input type="text" name="sdate" id="sdate" class="frm_input datepicker" size="12" value="<?=$sdate?>" autocomplete="off"> ~
    <input type="text" name="edate" id="edate" class="frm_input datepicker" size="12" value="<?=$edate?>" autocomplete="off">
...
<div class="tbl_head02 tbl_wrap">
    ...
    <thead>
    <tr>
        <th scope="col" rowspan="2" id="th_id" width="3%">ID</th>
