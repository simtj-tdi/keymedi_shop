...
<div class="btn_add01 btn_add">
	<a href="#" onclick="down_excel('./couponlist_excel.php');" id="member_add">엑셀다운</a>
	<a href="./coupon_excel.php" onclick="return excelform(this.href);" target="_blank">쿠폰일괄등록</a>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" width="6%">쿠폰종류</th>
        <th scope="col" width="10%">쿠폰코드</th>
        <th scope="col">쿠폰이름</th>
        <th scope="col" width="18%">적용대상</th>
        <th scope="col" width="5%"><?php echo subject_sort_link('mb_id') ?>회원아이디</a></th>
        <th scope="col" width="8%"><?php echo subject_sort_link('cp_end') ?>사용기한</a></th>
        <th scope="col" width="3%">사용회수</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mngsmall">
            <a href="./couponform.php?w=u&amp;cp_id=<?php echo $row['cp_id']; ?>&amp;<?php echo $qstr; ?>" class="btn btn-primary btn-xs"><span class="sound_only"><?php echo $row['cp_id']; ?> </span>수정</a>
        </td>
    </tr>
...
function down_excel(src){
	...
	document.fsearch.action = "./couponlist.php";
}
