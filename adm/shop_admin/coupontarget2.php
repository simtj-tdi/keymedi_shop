...
include_once(G5_PATH.'/head.sub.php');
	...
	$sql_where = " where mb_v = '4' ";
    if($sch_word)
        $sql_where .= " and mb_nick like '%$sch_word%' ";
    $sql_select = " select * ";
...
<div id="sch_target_frm" class="new_win scp_new_win">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tbody>
		<tr>
            <td colspan="2" align="center">전체공급사</td> 
            <td class="scp_target_select"><button type="button" class="btn_frmline" onclick="sel_target_id('all');">선택</button>
        </tr>
        <?php
        ...
        <tr>
            ...
            <td class="scp_target_select"><button type="button" class="btn_frmline" onclick="sel_target_id('<?php echo $row['mb_id']; ?>');">선택</button>
        </tr>
        <?php
        }
