...
<div class="tbl_head01 tbl_wrap" id="inorderlist">
    ...
    <tr>
        ...
        <th scope="col" width="5%">PG</th>
        <th scope="col">주문자</th>
        <th scope="col">주문자전화</th>
        <th scope="col">받는분</a></th>
        <th scope="col" width="5%">주문금액</a></th>
        <th scope="col" width="5%">결제방법</th>
        <th scope="col" width="8%">주문일시</th>
    ...
    <tr class="<?php echo $bg; ?>">
		...
		<td class="td_price"><?php echo number_format($data['price']); ?></td>
        <td class="td_center"><?php echo $data['od_settle_case']; ?></td>
        <td class="td_time"><?php echo $row['dt_time']; ?></td>
        <td class="td_mngsmall">
            <a href="./inorderform.php?od_id=<?php echo $row['od_id']; ?>&amp;<?php echo $qstr; ?>" class="btn btn-dark btn-xs"><span class="sound_only"><?php echo $row['od_id']; ?> </span>보기</a>
            <a href="./inorderformupdate.php?w=d&amp;od_id=<?php echo $row['od_id']; ?>&amp;<?php echo $qstr; ?>" onclick="return delete_confirm(this);" class="btn btn-danger btn-xs"><span class="sound_only"><?php echo $row['od_id']; ?> </span>삭제</a>
        </td>
    </tr>
