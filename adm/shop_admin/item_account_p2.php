...
<div style="margin:30px auto;" class="acount_boxs">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="700">
		...
		<tr height="22">
			...
			<td style="color:#1211ff;font-size:9pt;text-align:right;"  colspan="6" rowspan="2">(공급받는자 보관용)</td>
		</tr>
		<tr height="4">
			<td colspan="8"></td>
		</tr>
		...
		<tr>
			...
			<td style="height:22px;border-right:1px solid blue;border-bottom:1px solid blue; color:#1211ff;font-size:9pt;text-align:center;" colspan="8">품 &nbsp; 목 &nbsp; / &nbsp; 규 &nbsp; 격</td>
			...
			<td style="height:22px;border-right:1px solid blue;border-bottom:1px solid blue; color:#1211ff;font-size:9pt;text-align:center;" colspan="4">금액</td>
	...
	<?php FOR ($i=0; $row=sql_fetch_array($result); $i++){
		...
		<tr>
			...
			<td style="padding:2px;height:24px;border-right:2px solid blue; color:#222;font-size:9pt;text-align:right;padding-left:6px;<?php echo $bg_class; ?>" colspan="4"><?php echo number_format($total_send_cost); ?></td>
		</tr>
		...
		<tr>
			...
			</tr><tr><td style="padding:2px;height:24px;border-top:1px solid blue;border-bottom:2px solid blue;border-left:2px solid blue; color:#1211ff;font-size:9pt;text-align:center;" colspan="3">참고사항</td>
