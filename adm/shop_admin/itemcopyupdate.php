...
$dis_cnt = sql_fetch(" select count(*) as cnt from {$g5['g5_shop_item_table']} where it_8 = '$it_id' and it_10 = '$member[mb_id]' ");
if($dis_cnt[cnt] > 0){
	 alert('이미 존재하는 상품입니다.','/adm/shop_admin/itemlist.php');exit;
}
...
$sql_u = "update {$g5['g5_shop_item_table']} set it_8 = '$it_id' , it_10 = '$member[mb_id]' ,it_9 = '$new_it_9' ,  it_price = '$new_it_price' ,it_stock_qty = '$new_it_stock_qty' where it_id = '$new_it_id' ";
