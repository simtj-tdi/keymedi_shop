...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <td class="td_mng">
            <a href="./itemeventform.php?w=u&amp;ev_id=<?php echo $row['ev_id']; ?>" class="btn btn-primary btn-xs">수정</a>
            <a href="<?php echo G5_SHOP_URL; ?>/event.php?ev_id=<?php echo $row['ev_id']; ?>" class="btn btn-dark btn-xs">보기</a>
            <a href="./itemeventformupdate.php?w=d&amp;ev_id=<?php echo $row['ev_id']; ?>" onclick="return delete_confirm(this);" class="btn btn-danger btn-xs">삭제</a>
        </td>
    </tr>
