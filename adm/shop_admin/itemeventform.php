...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tbody>
	 <tr>
        <th>사이트구분</th>
		<td>
		<select name="ev_where" id="ev_where">
			...
			?>
				<option value="<?=$row_site[code]?>" <?=($row_site[code]==$ev['ev_where'])?"selected":"" ?>><?=$code_name?></option>
			<? } ?>
		</select>
		</td>
    </tr>
...
$(function() {
    ...
    $("#btn_search_item").click(function() {
        ...
        $("#sch_item_list").load(
            "./itemeventsearch.php",
            { site_fix : "<?php echo $site_fix ?>",w: "<?php echo $w; ?>", ev_id: "<?php echo $ev_id; ?>", ca_id: ca_id, it_name: it_name }
        );
    });
