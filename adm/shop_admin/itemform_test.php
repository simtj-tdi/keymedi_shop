...
if ($w == "") {
    ...
    if (!$it['ca_id']) {
        ...
        $row = sql_fetch($sql);
        if (!$row['ca_id']) alert("등록된 분류가 없습니다. 우선 분류를 등록하여 주십시오.", './categorylist.php');
        $it['ca_id'] = $row['ca_id'];
    }
...
if ($it[it_8]) {
    $frm_submit = '<div class="btn_confirm01 btn_confirm">
                    ...
                    <a href="./itemlist2.php?' . $qstr . '&amp;m_class=' . $m_class . '">목록</a>';
} else {
    $frm_submit = '<div class="btn_confirm01 btn_confirm">
                    <input type="submit" value="확인" class="btn_submit" accesskey="s">
                    <a href="./itemlist.php?' . $qstr . '&amp;m_class=' . $m_class . '">목록</a>';
}
if ($it_id) $frm_submit .= PHP_EOL . '<a href="' . G5_SHOP_URL . '/item.php?it_id=' . $it_id . '" class="btn_frmline">상품보기</a>';

$frm_submit .= '</div>';

// 쿠폰적용안함 설정 필드 추가
if (!sql_query(" select it_nocoupon from {$g5['g5_shop_item_table']} limit 1", false)) {
        sql_query(" ALTER TABLE `{$g5['g5_shop_item_table']}` ADD `it_nocoupon` tinyint(4) NOT NULL DEFAULT '0' AFTER `it_use` ", true);
}
...
$_row_ca_id_1 = substr($it['ca_id'],0,2);
$_row_ca_id_12 = substr($it['ca_id'],0,4);
$_row_ca_id_13 = substr($it['ca_id'],0,6);

$_row_ca_id_2 = substr($it['ca_id2'],0,2);
$_row_ca_id_22 = substr($it['ca_id2'],0,4);
$_row_ca_id_23 = substr($it['ca_id2'],0,6);

$_row_ca_id_3 = substr($it['ca_id3'],0,2);
$_row_ca_id_32 = substr($it['ca_id3'],0,4);
$_row_ca_id_33 = substr($it['ca_id3'],0,6);
?>
<script>
...
for($c=1;$c<4;$c++){
    ...
    if (${"_row_ca_id_".$c}) {
        echo "setTimeout(function() {
            document.getElementById('sca_ck').value = '" . ${"_row_ca_id_".$c.$cs} . "';
            ajax_cate('" . ${"_row_ca_id_".$c} . "','ca_id_".$c.$cs."','2','" . ${"_row_ca_id_".$c.$cs} . "');
        }, 1000);";
    ...
    if (${"_row_ca_id_".$c.$cs}) {
        echo "setTimeout(function() {
        document.getElementById('sca_ck').value = '" . ${"_row_ca_id_".$c.$ct} . "';
        ajax_cate('" . ${"_row_ca_id_".$c.$cs} . "','ca_id_".$c.$ct."','3','" . ${"_row_ca_id_".$c.$ct} . "');
    }, 2000);";
    }
}
...
<form name="fitemform" action="./itemformupdate_test.php" method="post" enctype="MULTIPART/FORM-DATA" autocomplete="off" onsubmit="return fitemformcheck(this)">
    ...
    <section id="anc_sitfrm_cate">
        ...
        <?php echo $pg_anchor; ?>
        <div class="local_desc02 local_desc"><p>기본분류는 반드시 선택하셔야 합니다. 하나의 상품에 최대 3개의 다른 분류를 지정할 수 있습니다.</p></div>
        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <?
                for($c=1;$c<4;$c++){
                    if($c==1) $_cateTitle = "기본분류";
                    else $_cateTitle = $c."차 분류";
                    ?>
                    <tr>
                        <th scope="row">
                            <label for="ca_id"><?=$_cateTitle?></label>
                        </th>
                        <td>
                            <select name="ca_id_<?=$c?>" id="ca_id_<?=$c?>" onchange="ajax_cate(this.value,'ca_id_<?=$c?>2','2','ca_id_<?=$c?>2');">
                                ...
                                for ($i = 0; $row1 = sql_fetch_array($result1); $i++) {
                                    echo '<option value="' . $row1['ca_id'] . '" ' . get_selected(${"_row_ca_id_".$c}, $row1['ca_id']) . '>' . $nbsp . $row1['ca_name'] . '</option>' . PHP_EOL;
                                }
                                ?>
                            </select>
                            ...
                            for ($i = 2; $i <= 3; $i++) {
                                ...
                                $onChange =  $i != 3 ? "onchange=\"ajax_cate(this.value,'".$sendId."');\"" : "" ;
                                ?>

                                <select name="<?=$_cateId?>" id="<?=$_cateId?>" <?=$onChange?>>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <?
                        if ($it[it_8]) {
                            $newsit = sql_fetch("select it_name,it_2,it_5, it_6, it_maker,it_cust_price from {$g5['g5_shop_item_table']} where it_id = '{$it[it_8]}'");
                            $it['it_name'] = $newsit['it_name'];
                        }
                        ?>
                ...
                <tr>
                    <th scope="row">상품유형(생협)</th>
                    <td>
                        <?php echo help("메인화면에 유형별로 출력할때 사용합니다.\n이곳에 체크하게되면 상품리스트에서 유형별로 정렬할때 체크된 상품이 가장 먼저 출력됩니다."); ?>
                        <input type="checkbox" name="it_type1"
                               value="1" <?php echo($it['it_type1'] ? "checked" : ""); ?> id="it_type1">
                        <label for="it_type1">히트 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_hit.gif" alt=""></label>
                        <input type="checkbox" name="it_type2"
                               value="1" <?php echo($it['it_type2'] ? "checked" : ""); ?> id="it_type2">
                        <label for="it_type2">추천 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_rec.gif" alt=""></label>
                        <input type="checkbox" name="it_type3"
                               value="1" <?php echo($it['it_type3'] ? "checked" : ""); ?> id="it_type3">
                        <label for="it_type3">신상품 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_new.gif" alt=""></label>
                        <input type="checkbox" name="it_type4"
                               value="1" <?php echo($it['it_type4'] ? "checked" : ""); ?> id="it_type4">
                        <label for="it_type4">인기 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_best.gif" alt=""></label>
                        <input type="checkbox" name="it_type5"
                               value="1" <?php echo($it['it_type5'] ? "checked" : ""); ?> id="it_type5">
                        <label for="it_type5">할인 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_discount.gif"
                                                      alt=""></label>
                    </td>
                    <!-- <td class="td_grpset">
                ...
                <tr>
                    <th scope="row">상품유형(메디몰)</th>
                    <td>
                        <?php echo help("메인화면에 유형별로 출력할때 사용합니다.\n이곳에 체크하게되면 상품리스트에서 유형별로 정렬할때 체크된 상품이 가장 먼저 출력됩니다."); ?>
                        <input type="checkbox" name="it_type11" value="1" <?php echo($it['it_type11'] ? "checked" : ""); ?> id="it_type11">
                        <label for="it_type11">히트 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_hit.gif" alt=""></label>
                        <input type="checkbox" name="it_type22" value="1" <?php echo($it['it_type22'] ? "checked" : ""); ?> id="it_type22">
                        <label for="it_type22">추천 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_rec.gif" alt=""></label>
                        <input type="checkbox" name="it_type33" value="1" <?php echo($it['it_type33'] ? "checked" : ""); ?> id="it_type33">
                        <label for="it_type33">신상품 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_new.gif" alt=""></label>
                        <input type="checkbox" name="it_type44" value="1" <?php echo($it['it_type44'] ? "checked" : ""); ?> id="it_type44">
                        <label for="it_type44">인기 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_best.gif" alt=""></label>
                        <input type="checkbox" name="it_type55" value="1" <?php echo($it['it_type55'] ? "checked" : ""); ?> id="it_type55">
                        <label for="it_type55">할인 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_discount.gif" alt=""></label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="td_extra">
                        <input name="it_1" value="<?php echo get_text($it['it_1']); ?>" id="it_1" class="frm_input" type="text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">표준코드</th>
                    <td class="td_extra">
                        <input name="it_2" value="<?php echo get_text($it['it_2']); ?>" id="it_2" class="frm_input" type="text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">효능/효과</th>
                    <td class="td_extra">
                        <input name="it_3" value="<?php echo get_text($it['it_3']); ?>" id="it_3" class="frm_input" type="text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">주요성분</th>
                    <td class="td_extra">
                        <input name="it_4" value="<?php echo get_text($it['it_4']); ?>" id="it_4" class="frm_input" type="text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">규격</th>
                    <td class="td_extra">
                        <input name="it_5" value="<?php echo get_text($it['it_5']); ?>" id="it_5" class="frm_input" type="text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">단위</th>
                    <td class="td_extra">
                        <input name="it_6" value="<?php echo get_text($it['it_6']); ?>" id="it_6" class="frm_input" type="text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">부모마스터코드</th>
                    <td class="td_extra">
                        <input name="it_8" value="<?php echo get_text($it['it_8']); ?>" id="it_8" class="frm_input" type="text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">제약사코드</th>
                    <td class="td_extra">
                        <input name="it_9" value="<?php echo get_text($it['it_9']); ?>" id="it_9" class="frm_input" type="text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">특가수수료</th>
                    <td class="td_extra">
                        <input name="it_s_commission" value="<?php echo get_text($it['it_s_commission']); ?>" id="it_s_commission" class="frm_input" type="text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">수수료</th>
                    <td class="td_extra">
                        <input name="it_commission" value="<?php echo get_text($it['it_commission']); ?>" id="it_commission" class="frm_input" type="text">
                    </td>
                </tr>


                <tr>
                    <th scope="row">급여상품</th>
                    <td class="td_extra">
                        <select name="it_tax">
                            <option value="0" <?= ($it['it_tax'] == "0") ? "selected" : "" ?>>비급여</option>
                            <option value="1" <?= ($it['it_tax'] == "1") ? "selected" : "" ?>>급여</option>
                        </select>
                    </td>
                </tr>
                ...
                <? } else { ?>
                    <input type="hidden" name="it_use" value="<?php echo $it['it_use'] ?>" id="it_use">
                <? } ?>
                <tr>
                ...
                <tr>
                    ...
                    <td><textarea name="it_shop_memo" id="it_shop_memo"><?php echo $it['it_shop_memo']; ?></textarea>
                    </td>
                </tr>
                </tbody>
            </table>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="it_point" value="<?php echo $it['it_point']; ?>" id="it_point" class="frm_input" size="8">
                        <span id="it_point_unit"><?php if ($it['it_point_type']) echo '%'; else echo '점'; ?></span>
                    </td>
                    ...
                    <td colspan="2">
                        <div id="sit_supply_frm" class="sit_option tbl_frm01">
                            ...
                            <div id="sit_option_addfrm_btn">
                                <button type="button" id="add_supply_row" class="btn_frmline">옵션추가</button>
                            </div>
                            <div class="btn_confirm02 btn_confirm">
                    ...
                    for ($g = 0; $row = sql_fetch_array($result); $g++) {
                        ...
                        <li>
                            ...
                            <div class="list_item_btn">
                                <button type="button" class="del_item btn_frmline">삭제</button>
                            </div>
                        </li>
                        <?php
                        $str[] = $row['it_id'];
                ...
                <div id="event_list" class="srel_list srel_noneimg">
                    ...
                    for ($g = 0; $row = sql_fetch_array($result); $g++) {
                        ...
                        <li>
                            ...
                            <div class="list_item_btn">
                                <button type="button" class="add_event btn_frmline">추가</button>
                            </div>
                        </li>
                        <?php
                    }
                ...
                <div id="reg_event_list" class="srel_sel srel_noneimg">
                    ...
                    for ($g = 0; $row = sql_fetch_array($result); $g++) {
                        ...
                        <li>
                            ...
                            <div class="list_item"><?php echo get_text($row['ev_subject']); ?></div>
                            <div class="list_item_btn">
                                <button type="button" class="del_event btn_frmline">삭제</button>
                            </div>
                        </li>
                        <?php
                    }
