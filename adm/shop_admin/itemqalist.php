...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" width="35%"><?php echo subject_sort_link('iq_subject'); ?>질문</a></th>
        <th scope="col" width="5%"><?php echo subject_sort_link('mb_name'); ?>이름</a></th>
        <th scope="col" width="5%"><?php echo subject_sort_link('iq_answer'); ?>답변</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mngsmall">
            <a href="./itemqaform.php?w=u&amp;iq_id=<?php echo $row['iq_id']; ?>&amp;<?php echo $qstr; ?>"  class="btn btn-primary btn-xs"><span class="sound_only"><?php echo get_text($row['iq_subject']); ?> </span>수정</a>
        </td>
    </tr>
    <?php
    }
