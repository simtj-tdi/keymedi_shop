...
$sel_ca_id1 = get_search_string($sel_ca_id1);
$sel_ca_id2 = get_search_string($sel_ca_id2);
$sel_ca_id3 = get_search_string($sel_ca_id3);
...
<div class="tbl_head01 tbl_wrap">
    ...
    <thead>
    <tr>
        <th scope="col" width="5%"><a href="<?php echo title_sort("it_id") . "&amp;$qstr1"; ?>">상품코드</a></th>
        <th scope="col"><a href="<?php echo title_sort("it_name") . "&amp;$qstr1"; ?>">상품명</a></th>
        <th scope="col" width="5%"><a href="<?php echo title_sort("it_stock_qty") . "&amp;$qstr1"; ?>">창고재고</a></th>
        <th scope="col" width="4%">주문대기</th>
        <th scope="col" width="5%">가재고</th>
        <th scope="col" width="5%">재고수정</th>
        <th scope="col" width="5%">통보수량</th>
        <th scope="col" width="2%"><a href="<?php echo title_sort("it_use") . "&amp;$qstr1"; ?>">판매</a></th>
        <th scope="col" width="2%"><a href="<?php echo title_sort("it_soldout") . "&amp;$qstr1"; ?>">품절</a></th>
        <th scope="col" width="4%"><a href="<?php echo title_sort("it_stock_sms") . "&amp;$qstr1"; ?>">재입고알림</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mngsmall"><a href="./itemform.php?w=u&amp;it_id=<?php echo $row['it_id']; ?>&amp;ca_id=<?php echo $row['ca_id']; ?>&amp;<?php echo $qstr; ?>" class="btn btn-primary btn-xs">수정</a></td>
    </tr>
    <?php
    }
    if (!$i)
