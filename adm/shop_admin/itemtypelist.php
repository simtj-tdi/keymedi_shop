...
<div class="btn_add01 btn_add">
	<a href="#" onclick="down_excel('./itemtypelist_excel.php');" id="member_add">엑셀다운</a> 
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" width="3%"><?php echo subject_sort_link("it_type1", $qstr, 1); ?>히트상품</a></th>
        ...
        <th scope="col"width="3%"><?php echo subject_sort_link("it_type4", $qstr, 1); ?>인기상품</a></th>
        <th scope="col"width="3%"><?php echo subject_sort_link("it_type5", $qstr, 1); ?>할인상품</a></th>
...
function down_excel(src){
	...
	document.flist.action = "./itemtypelist.php";
}
