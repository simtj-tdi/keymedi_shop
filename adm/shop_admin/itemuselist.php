...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" width="25%"><?php echo subject_sort_link("it_name"); ?>상품명</a></th>
        <th scope="col" width="5%"><?php echo subject_sort_link("mb_name"); ?>이름</a></th>
        <th scope="col"><?php echo subject_sort_link("is_subject"); ?>제목</a></th>
        <th scope="col" width="5%"><?php echo subject_sort_link("is_score"); ?>평점</a></th>
        <th scope="col" width="5%"><?php echo subject_sort_link("is_confirm"); ?>확인</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mngsmall">
            <a href="./itemuseform.php?w=u&amp;is_id=<?php echo $row['is_id']; ?>&amp;<?php echo $qstr; ?>" class="btn btn-primary btn-xs"><span class="sound_only"><?php echo get_text($row['is_subject']); ?> </span>수정</a>
        </td>
    </tr>
