...
<select name="m_site" id="m_site">
	...
	?>
		<option value="<?=$row_site[pay_code]?>" <?php echo get_selected($m_site, $row_site[pay_code]); ?> ><?=$row_site[code_name]?></option>
	<? } ?>
...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr class="orderlist<?php echo ' '.$bg; ?>">
		...
		<td rowspan="3" class="td_odrnum2"><?=get_sitename(substr($row['od_id'],0,2))?></td>
		<?if($is_admin){?>
        ...
        <td rowspan="3" class="td_numincome"><?php echo number_format($row['od_receipt_price']-$row['od_receipt_point']-$row['couponprice']); ?></td>
