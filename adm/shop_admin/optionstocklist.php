...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" width="8%">옵션항목</th>
        <th scope="col" width="5%">옵션타입</th>
        <th scope="col" width="5%"><a href="<?php echo title_sort("a.io_stock_qty") . "&amp;$qstr1"; ?>">창고재고</a></th>
        <th scope="col" width="3%">주문대기</th>
        <th scope="col" width="5%">가재고</th>
        <th scope="col" width="5%">재고수정</th>
        <th scope="col" width="5%">통보수량</th>
        <th scope="col" width="3%"><a href="<?php echo title_sort("a.io_use") . "&amp;$qstr1"; ?>">판매</a></th>
