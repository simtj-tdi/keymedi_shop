...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col">제목</th>
        <th scope="col" width="8%"><?php echo subject_sort_link('od_id') ?>주문번호</a></th>
        <th scope="col" width="4%">주문금액</th>
        <th scope="col" width="4%">입금금액</th>
        <th scope="col" width="4%">미수금액</th>
        <th scope="col" width="4%">입금방법</a></th>
        <th scope="col" width="5%"><?php echo subject_sort_link('pp_receipt_time') ?>입금일</a></a></th>
        <th scope="col" width="3%">사용</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mngsmall">
            <a href="./personalpayform.php?w=u&amp;pp_id=<?php echo $row['pp_id']; ?>&amp;<?php echo $qstr; ?>" class="btn btn-primary btn-xs"><span class="sound_only"><?php echo $row['pp_id']; ?> </span>수정</a>
            <a href="./personalpaycopy.php?pp_id=<?php echo $row['pp_id']; ?>" class="personalpaycopy btn btn-warning btn-xs"><span class="sound_only"><?php echo $row['pp_id']; ?> </span>복사</a>
        </td>
    </tr>
