...
define('G5_MYSQL_HOST', '192.168.131.171');
define('G5_MYSQL_USER', 'keydoc');
define('G5_MYSQL_PASSWORD', 'keydoc!@#');
define('G5_MYSQL_DB', 'shop');
...
$g5['event_table'] = G5_TABLE_PREFIX.'event_goods'; // 이벤트 상품 테이블
