...
<? 
/*
	if($it_id == "1539741258" || $it_id == "154891406548"){

		if($sub_item != "Y"){
			$tmp = sql_fetch("select it_name,it_8,it_10 from g5_shop_item where it_id = '{$it_id}' and it_use = '1' ");
			$sql = "select a.it_id , a.it_name , a.it_price , a.it_stock_qty , a.it_10 ,b.mb_nick from g5_shop_item a , g5_member b where a.it_10 = b.mb_id and it_8 = '{$it_id}' and it_use = '1'  order by it_stock_qty  asc";
		}else{
			$tmp = sql_fetch("select it_name,it_8,it_10 from g5_shop_item where it_id = '{$it_id}' and it_use = '1' ");
			$sql = "select a.it_id , a.it_name , a.it_price , a.it_stock_qty , a.it_10 , b.mb_nick from g5_shop_item a , g5_member b where a.it_10 = b.mb_id and it_8 = '{$tmp[it_8]}' and it_use = '1'  order by it_stock_qty  asc";
		}
	}else{
	*/
		if($sub_item != "Y"){
			$tmp = sql_fetch("select it_name,it_8,it_10 from g5_shop_item where it_id = '{$it_id}' and it_use = '1' ");
			$sql = "select a.it_id , a.it_name , a.it_price , a.it_stock_qty , a.it_10 ,b.mb_nick from g5_shop_item a , g5_member b where a.it_10 = b.mb_id and it_8 = '{$it_id}' and it_use = '1'  order by it_price asc , it_stock_qty desc";
		}else{
			$tmp = sql_fetch("select it_name,it_8,it_10 from g5_shop_item where it_id = '{$it_id}' and it_use = '1' ");
			$sql = "select a.it_id , a.it_name , a.it_price , a.it_stock_qty , a.it_10 , b.mb_nick from g5_shop_item a , g5_member b where a.it_10 = b.mb_id and it_8 = '{$tmp[it_8]}' and it_use = '1'  order by it_price asc , it_stock_qty desc";
		}
	//}
	
	if($tmp[it_8]){ 
		$newsit = sql_fetch("select it_name from {$g5['g5_shop_item_table']} where it_id = '{$tmp[it_8]}'"); 
		$tmp['it_name'] = $newsit['it_name']; 
	}
...
?>
	...
	?>
			<tr>
				<td width="50" style="color:#989898;"><input type="radio" name="ck[]" value="<?=$row[it_id]?>" onclick="viewitem('<?=$row[it_id]?>');" <?=($it_id == $row[it_id])?"checked":""?>  style="color:#989898;"/></td>
				<td ><?if($cp_count>0 && substr($it['ca_id'],0,2) != "20" ){?><img src="/shop/img/icon_cp.gif"><?}?><a href="#" onclick="viewitem('<?=$row[it_id]?>');" style="color:#989898;"><?=$row[mb_nick]?></a></td>
	...
	<? //} ?>
	<script>
	function viewitem(it_id){
		document.location.href = "/shop/item.php?it_id="+it_id+"&no_frame=no&sub_item=Y";	
	}
	...
	if(bchk == false){
		if(chk[0].value){
			document.location.href = "/shop/item.php?it_id="+chk[0].value+"&no_frame=no&sub_item=Y";	
		}else{
