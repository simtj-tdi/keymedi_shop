...
<div id="sod_fin">
	...
	<div id="sub_top_new_menu"> 
		...
		<span><a href="/shop/coupon.php">쿠폰/포인트</a></span>
    ...
    <div id="seller_frm">
     <?
		$sell = sql_fetch("select * from shop.g5_member where mb_v = '4' and mb_leave_date = '' and mb_id = '$od[com_id]' ");
		switch($sell[mb_13]){
	 ...
	 ?> 
		...
		<div class="sell_box2" style="margin-top:0px;">
			<div class="sell_box_left" style="padding-top:60px;height:90px;">
				상태설명		
			</div>
			<div class="sell_box_right">
				 <div class="step_img">
					<img src="<?php echo G5_IMG_URL ?>/mypage/order_01_<?=($od['od_status']=="주문")?"on":"off"?>.png" alt="주문">
					<strong>주문</strong>
					<p class="<?=($od['od_status']=="주문")?"ov":""?>">주문서 확인</p>
				</div>
				 <div class="step_img_bar1"><img src="<?php echo G5_IMG_URL ?>/mypage/btn<?=($od['od_status']=="주문")?"_on":""?>.png" alt="" class="arr_icon1"></div>
				 <div class="step_img">
					<img src="<?php echo G5_IMG_URL ?>/mypage/order_02_<?=($od['od_status']=="입금")?"on":"off"?>.png" alt="입금">
					<strong>입금</strong>
					<p class="<?=($od['od_status']=="입금")?"ov":""?>">결제완료</p>
				</div>
				 <div class="step_img_bar2"><img src="<?php echo G5_IMG_URL ?>/mypage/btn<?=($od['od_status']=="입금")?"_on":""?>.png" alt="" class="arr_icon1"></div>
				 <div class="step_img">
					<img src="<?php echo G5_IMG_URL ?>/mypage/order_03_<?=($od['od_status']=="준비")?"on":"off"?>.png" alt="상품준비중">
					<strong>상품준비중</strong>
					<p class="<?=($od['od_status']=="준비")?"ov":""?>">배송전 상품준비단계</p>
				 </div>
				 <div class="step_img_bar3"><img src="<?php echo G5_IMG_URL ?>/mypage/btn<?=($od['od_status']=="준비")?"_on":""?>.png" alt="" class="arr_icon1"></div>
				 <div class="step_img">
					<img src="<?php echo G5_IMG_URL ?>/mypage/order_04_<?=($od['od_status']=="배송")?"on":"off"?>.png" alt="배송중">
					<strong>배송중</strong>
					<p class="<?=($od['od_status']=="배송")?"ov":""?>">택배사를 통해 배송중</p>
				</div>
				 <div class="step_img_bar4"><img src="<?php echo G5_IMG_URL ?>/mypage/btn<?=($od['od_status']=="배송")?"_on":""?>.png" alt="" class="arr_icon1"></div>
				 <div class="step_img">
					<img src="<?php echo G5_IMG_URL ?>/mypage/order_05_<?=($od['od_status']=="완료")?"on":"off"?>.png" alt="완료">
					<strong>완료</strong>
					<p class="<?=($od['od_status']=="완료")?"ov":""?>">배송완료</p>
				 </div>
			</div>			
		</div>
    ...
    <section id="sod_fin_list">
        ...
        $sql = " select it_id, it_name, ct_send_cost, it_sc_type, ct_option, io_id, io_price, com_od_id
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tr>
                ...
                <th scope="col" width="80" id="th_itpt">배송비</th>
                <th scope="col" width="120" id="th_itst">상태</th>
            </tr>
            </thead>
            <tbody>
            <?php
            ...
            <tr>
                ...
                <td headers="th_itopt" style="text-align:center;">
        ...
        $tot_price = $od['od_cart_price'] + $od['od_send_cost'] + $od['od_send_cost2']
                        - $od['od_cart_coupon'] - $sql_cc['od_cart_coupon_sum'] - $od['od_coupon'] - $od['od_send_coupon']
		...
		<div style="position:relative;width:100%;height:135px;background:url('/img/sum_price.jpg') no-repeat;">
			<strong style="position:absolute;width:235px;left:0;top:60px;text-align:center;font-size:18px;"><?php echo number_format($od['od_cart_price']); ?> 원</strong>	
			<strong style="position:absolute;width:235px;left:235px;;top:60px;text-align:center;font-size:18px;"><?php echo number_format($od['od_send_cost']); ?> 원</strong>
		 
			<strong style="position:absolute;width:235px;left:470px;;top:60px;text-align:center;font-size:18px;" id="ct_tot_coupon"><?php echo number_format($od['od_cart_coupon']+$sql_cc['od_cart_coupon_sum']+$od['od_coupon']+$od['od_send_coupon']); ?> 원</strong>
			<strong style="position:absolute;width:235px;left:705px;;top:60px;text-align:center;font-size:18px;" id="ct_tot_point"><?php echo number_format($od['od_receipt_point']); ?> 점</strong>
...
<!-- 
        <dl id="sod_bsk_tot">
            ...
            <?php } ?>
			  <?php if($sql_cc['od_cart_coupon_sum'] > 0) { ?>
            <dt class="sod_bsk_dvr">개별상품 쿠폰할인</dt>
            <dd class="sod_bsk_dvr"><strong><?php echo number_format($sql_cc['od_cart_coupon_sum']); ?> 원</strong></dd>
            <?php } ?>
            ...
            <dt class="sod_bsk_dvr">포인트사용</dt>
            <dd class="sod_bsk_dvr"><strong><?php echo number_format($od['od_receipt_point']); ?> 원</strong></dd>
            <?php } ?> 
