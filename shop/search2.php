...
if(SITE_CODE == "mall"){
	$where = array();
	$where[] = " (a.ca_id = b.ca_id and a.it_use = 1 and b.ca_use = 1) and a.it_8 ='' and it_type55 = '1' ";
}else{
	$where = array();
	$where[] = " (a.ca_id = b.ca_id and a.it_use = 1 and b.ca_use = 1) and a.it_8 ='' and it_type5 = '1' ";
}
*/
$where = array();
	$where[] = " (a.ca_id = b.ca_id and a.it_use = 1 and b.ca_use = 1) and a.it_8 ='' and it_type5 = '1' ";
...
*/
$q2       = utf8_strcut(trim($_GET['q2']), 30, "");
...
if ($qfrom && $qto)
 ...
 $where[] = " (SELECT COUNT(it_id) FROM g5_shop_item WHERE it_8 = a.it_id) > 0 ";
...
<div id="ssch">
    ...
    <div id="ssch_frm">
        ...
        <div>
            ...
            <input type="text" name="q2" value="<?php echo $q2; ?>" id="ssch_q" class="frm_input" size="40" maxlength="30">
