...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            ...
            <td> 
				<input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="frm_input required datepicker" size="10" maxlength="255">
				~
				<input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="frm_input required datepicker" size="10" maxlength="255">	
            </td>
        </tr>
