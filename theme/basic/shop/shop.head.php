...
?>
<div id="fullgray" class=""></div>
<div id="wrap">
<?php
if(defined('_INDEX_')) { // index에서만 실행
?>
	<div id="popup_zone1">
		<?php echo display_banner('산협몰_상단', 'mainbanner.30.skin.php'); ?>
	</div>
<? } ?>
	...
	<div id="login_wraps"  style="display:none;">
		<div id="login_boxs"  >
			...
			<form name="flogin" action="http://www.kacsmall.com/bbs/login_check.php" onsubmit="return flogin_submit(this);" method="post">
			<input type="hidden" name="url" value="http://shop.kacsmall.com/">
			...
			<fieldset id="login_fs">
				...
				<input type="checkbox" name="auto_login" id="login_auto_login" <?=(get_cookie('ck_mb_id'))?"checked":""?>> 
					...
					<a href="http://www.kacsmall.com/help/id_01.php"  ><img src="/img/nt.png" alt="아이디찾기" class="btn_02"></a>
					<a href="http://www.kacsmall.com/help/pw_01.php"  ><img src="/img/nt.png" alt="비밀번호찾기" class="btn_03"></a>
					<a href="http://www.kacsmall.com/bbs/register.php"><img src="/img/nt.png" alt="회원 가입" class="btn_01"></a>
			</form>
		</div>
	</div>
...
function close_login(){ 
	...
	<div id="head_wrap">
			...
			<div id="head_top">
				...
				<div id="head_dot2">
					<ul>
						...
						<li class="fL"><img src="<?php echo G5_IMG_URL ?>/main/top/join_icon.png" alt="" > <a href="http://www.kacsmall.com/bbs/register.php">회원가입</a></li> 
						<?php }  ?> 
		...
		<div id="head">
			<?php
			/**	201224 - burtonpro */
			$head_img_name = 'top_logo_201224.png' ;
			$head_img_style = "style='width:240px;margin-top:10px;'" ;
			//  burtonpro
			// if( $member['mb_id'] != 'test10' ) {
			// 	$head_img_name = 'top_logo.png' ;
			// 	$head_img_style = "" ;
			// }
			?>
			<h1><a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/main/top/<?=$head_img_name?>" <?=$head_img_style?> alt="<?php echo $config['cf_title']; ?>"></a></h1>
			...
			<div id="head_dot3">
				<?
					...
					if($sso[in_id]){
						/*$url_link = "/bbs/content.php?co_id=0205&tab=vod&vod_select=%EB%8C%80%ED%95%9C%EC%82%B0%EB%B6%80%EC%9D%B8%EA%B3%BC%EC%9D%98%EC%82%AC%ED%9A%8C&price=&stx=&sst=wr_2&sod=desc";*/
                        $url_link = "/";
						//$url_link = "/bbs/board.php?bo_table=0101&wr_id=3066&type=1";

						$url_link = urlencode($url_link);
						$url_sso = "https://www.keymedi.com/sso2.php?return_url=".$url_link."&in_id=".$sso[in_id];
						$sso_onclick = "";
					}else{
						$url_sso = "#";
				...
				?>
				 <a href="<?=$url_sso?>" <?=$sso_onclick?> target="_blank"><img src="/img/main/top/top_bn2.jpg" alt=""></a>
				<!-- <a href="http://www.keymedi.com/bbs/board.php?bo_table=0101&type=4&mbw=1" target="_blank"><img src="<?php echo G5_IMG_URL ?>/main/top/top_bn.png" alt=""></a> -->
			</div>
		</div>
		<div id="head_menu_wrap">
			<div id="head_menu">
				<ul class="dp1"> 
					...
					<?php
					//  burtonpro - 201224
					$menu01_style = "style='display:none;'" ;
					// if( $member['mb_id'] != 'test10' ) {
					// 	$menu01_style = "" ;
					// }
					?>
					<li class="fL dept" <?=$menu01_style?>><a href="<?php echo G5_BBS_URL ?>/content.php?co_id=0101" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('menu_1','','<?php echo G5_IMG_URL ?>/main/top2/menu_01ov.png',1);"><img src="<?php echo G5_IMG_URL ?>/main/top2/menu_01.png" alt="" name="menu_1" id="menu_1" /></a></li>

					<li class="fL dept"><a href="<?php echo G5_SHOP_URL; ?>/event.php?sort=it_update_time&sortodr=desc" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('menu_2','','<?php echo G5_IMG_URL ?>/main/top2/menu_02ov.png',1);"><img src="<?php echo G5_IMG_URL ?>/main/top2/menu_02.png" alt="" name="menu_2" id="menu_2" /></a></li>
					<li class="fL dept showcate2"><a href="#" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('menu_3','','<?php echo G5_IMG_URL ?>/main/top2/menu_03ov.png',1);"><img src="<?php echo G5_IMG_URL ?>/main/top2/menu_03.png" alt="" name="menu_3" id="menu_3" /></a></li>
					<li class="fL dept"><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=event" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('menu_4','','<?php echo G5_IMG_URL ?>/main/top2/menu_04ov.png',1);"><img src="<?php echo G5_IMG_URL ?>/main/top2/menu_04.png" alt="" name="menu_4" id="menu_4" /></a></li>
					<li class="fL dept"><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=0401" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('menu_5','','<?php echo G5_IMG_URL ?>/main/top2/menu_05ov.png',1);"><img src="<?php echo G5_IMG_URL ?>/main/top2/menu_05.png" alt="" name="menu_5" id="menu_5" /></a></li>
					<li class="fL dept"><a href="<?php echo G5_SHOP_URL; ?>/mypage.php" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('menu_6','','<?php echo G5_IMG_URL ?>/main/top2/menu_06ov.png',1);"><img src="<?php echo G5_IMG_URL ?>/main/top2/menu_06.png" alt="" name="menu_6" id="menu_6" /></a></li>
					<li class="fL dept"><a href="http://gigi.keymedi.com/" target="_blank" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('menu_7','','<?php echo G5_IMG_URL ?>/main/top2/menu_07ov.png',1);"><img src="<?php echo G5_IMG_URL ?>/main/top2/menu_07.png" alt="" name="menu_7" id="menu_7" /></a></li>
					
				</ul>
				<div id="cate_full" style="height:0px;">
					<div id="cate_full_dep1">
						<ul>
						<?php
						$sql1 = " select ca_id, ca_name from {$g5['g5_shop_category_table']} where LENGTH(ca_id) = '2' and ca_use = '1' and ca_id != 'i0' and left(ca_id,1) != 'f'  and site_code like '%obgys%' order by ca_id , ca_order ";
					...
					<table width="100%" style="border-collapse: collapse;border-spacing: 0;">
						<tbody>
							<tr>
								...
								<?
									$sql = "select * from {$g5['member_table']} where mb_v = '4' and mb_leave_date = '' and mb_13 = '1' and mb_28 like '%shop%' order by mb_nick asc"; 
									$res = sql_query($sql);
							...
							<tr>
								...
								<td style="padding:20px;border-bottom:1px solid #d7d7d7;">
								<?
									$sql = "select * from {$g5['member_table']} where mb_v = '4' and mb_leave_date = '' and mb_13 = '2' and mb_28 like '%shop%' order by mb_nick asc"; 
									$res = sql_query($sql);
									while($row = sql_fetch_array($res)){
								?>
										<li class="fL" style="width:20%;height:30px;"><a href="/shop/seller.php?s_select=it_10&q2=<?=$row[mb_id]?>" style="font-size:15px;color:#646464;"><?=$row[mb_nick]?></a></li>
							...
							<tr>
								...
								<td style="padding:20px;border-bottom:1px solid #d7d7d7;">
								<?
									$sql = "select * from {$g5['member_table']} where mb_v = '4' and mb_leave_date = '' and mb_13 = '3' and mb_28 like '%shop%' order by mb_nick asc"; 
									$res = sql_query($sql);
									while($row = sql_fetch_array($res)){
								?>
										<li class="fL" style="width:20%;height:30px;"><a href="/shop/seller.php?s_select=it_10&q2=<?=$row[mb_id]?>" style="font-size:15px;color:#646464;"><?=$row[mb_nick]?></a></li>
							...
							<tr>
								...
								<td style="padding:20px;border-bottom:1px solid #d7d7d7;">
								<?
									$sql = "select * from {$g5['member_table']} where mb_v = '4' and mb_leave_date = '' and mb_13 = '4' and mb_28 like '%shop%' order by mb_nick asc"; 
									$res = sql_query($sql);
									while($row = sql_fetch_array($res)){
								?>
										<li class="fL" style="width:20%;height:30px;"><a href="/shop/seller.php?s_select=it_10&q2=<?=$row[mb_id]?>" style="font-size:15px;color:#646464;"><?=$row[mb_nick]?></a></li>
				...
				<div id="right_quick">
					...
					<a href="#" onclick="show_cp();return false;"><img src="/img/quick_kakao_80x80.jpg" width="78" alt="" style="border:1px solid #e1e1e1;border-bottom:none;"/></a>
...
?>
	...
	<? if($bo_table == "0401" || $bo_table == "0402" || $bo_table == "0403"  || $bo_table == "0405" || $_SERVER['PHP_SELF']=="/bbs/faq.php"){?>
	<style>
