...
<div id="sub_top_new_menu"> 
	...
	<span class="ov"><a href="/shop/coupon.php">쿠폰/포인트</a></span>
...
<div id="item_ex_box2">
	...
	<div id="item_s_22" class="ovtop"><a href="/bbs/point.php">포인트</a></div>
...
<div id="point" class="new_win">
	...
	<h2 style="font-size:18px;text-indent:20px;margin-bottom:10px;">보유보인트 <span style="color:#02a2e3;"><?php echo number_format($member['mb_point']); ?></span>점</h2>
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
			...
			<td style="font-size:14px;"><?=$row[po_content]?></td>
