...
include_once(G5_THEME_SHOP_PATH.'/shop.head.new.php');
?>
    <div id="main_vs">
        <!-- 메인이미지 시작 { -->
        <?php echo display_banner('키메디메인', 'mainbanner.20.skin.php'); ?>
        <!-- } 메인이미지 끝 -->
        <div id="new_items">
            ...
            <div class="mContents">
                <ul class="mWrapper">
                    <?
                    $sql = "select * from {$g5['g5_shop_item_table']}  where it_use = '1' and it_8 = '' and it_type33 = '1' order by it_time desc limit 10  ";
    ...
    <div id="main_wrap">
        ...
        <div id="main_01">
            ...
            $sql = "select * from {$g5['g5_shop_item_table']} where it_use = '1' and it_type11 = '1' and it_8 = '' order by it_order, it_id desc limit 5 ";
            /*
    ...
    <div id="main_03_wrap">
        <div id="main_03">
            ...
            <div id="main_0304">
                ...
                <dl>
                    <?
                    $sql = "select wr_id , wr_subject , wr_datetime  from g5_write_0401 where wr_is_comment = 0 and (ca_name='메디포털' or ca_name='전체') order by wr_id desc limit 5";
                    $res = sql_query($sql);
                    while($row = sql_fetch_array($res)){
                        ?>
    ...
    <div id="main_02">
        ...
        <div class="main_02_itembox" id="main_02_item_1">
            <?
            $sql = "select * from ( select * , (SELECT COUNT(*) FROM g5_shop_item WHERE it_8 = m.it_id) AS cnt from {$g5['g5_shop_item_table']} m where it_use = '1' and ( ca_id like 'j0%' or ca_id2 like 'j0%' or ca_id3 like 'j0%' ) and it_8 ='' and it_type22 = '1' order by it_order, it_id desc ) a WHERE a.cnt > 0 limit 10 ";
            $res = sql_query($sql);
            for($i=0;$row = sql_fetch_array($res);$i++){ ?>
        ...
        <div class="main_02_itembox" id="main_02_item_2">
            <?
            $sql = "select * from ( select * , (SELECT COUNT(*) FROM g5_shop_item WHERE it_8 = m.it_id) AS cnt from {$g5['g5_shop_item_table']} m where it_use = '1' and ( ca_id like '10%' or ca_id2 like '10%' or ca_id3 like '10%' ) and it_8 ='' and it_type22 = '1' order by it_order, it_id desc ) a WHERE a.cnt > 0 limit 10 ";
            $res = sql_query($sql);
            for($i=0;$row = sql_fetch_array($res);$i++){ ?>
                <? $pri = sql_fetch("select it_price from {$g5['g5_shop_item_table']} where  it_use = '1' and it_8 = '{$row[it_id]}' order by it_price asc limit 1");?>
                <dl>
        ...
        <div class="main_02_itembox" id="main_02_item_3">
            <?
            $sql = "select * from ( select * , (SELECT COUNT(*) FROM g5_shop_item WHERE it_8 = m.it_id) AS cnt from {$g5['g5_shop_item_table']} m where it_use = '1' and ( ca_id like '30%' or ca_id2 like '30%' or ca_id3 like '30%' ) and it_8 ='' and it_type22 = '1' order by it_order, it_id desc ) a WHERE a.cnt > 0 limit 10 ";
            $res = sql_query($sql);
            for($i=0;$row = sql_fetch_array($res);$i++){ ?>
                <? $pri = sql_fetch("select it_price from {$g5['g5_shop_item_table']} where  it_use = '1' and it_8 = '{$row[it_id]}' order by it_price asc limit 1");?>
                <dl>
        ...
        <div class="main_02_itembox" id="main_02_item_4">
            <?
            $sql = "select * from ( select * , (SELECT COUNT(*) FROM g5_shop_item WHERE it_8 = m.it_id) AS cnt from {$g5['g5_shop_item_table']} m where it_use = '1' and ( ca_id like '20%' or ca_id2 like '20%' or ca_id3 like '20%' ) and it_8 ='' and it_type22 = '1' order by it_order, it_id desc ) a WHERE a.cnt > 0 limit 10 ";
            $res = sql_query($sql);
            for($i=0;$row = sql_fetch_array($res);$i++){ ?>
                <? $pri = sql_fetch("select it_price from {$g5['g5_shop_item_table']} where  it_use = '1' and it_8 = '{$row[it_id]}' order by it_price asc limit 1");?>
                <dl>
        ...
        <div class="main_02_itembox" id="main_02_item_5">
            <?
            $sql = "select * from ( select * , (SELECT COUNT(*) FROM g5_shop_item WHERE it_8 = m.it_id) AS cnt from {$g5['g5_shop_item_table']} m where it_use = '1' and ( ca_id like 'b0%' or ca_id2 like 'b0%' or ca_id3 like 'b0%' ) and it_8 ='' and it_type22 = '1' order by it_order, it_id desc ) a WHERE a.cnt > 0 limit 10 ";
            $res = sql_query($sql);
            for($i=0;$row = sql_fetch_array($res);$i++){ ?>
                <? $pri = sql_fetch("select it_price from {$g5['g5_shop_item_table']} where  it_use = '1' and it_8 = '{$row[it_id]}' order by it_price asc limit 1");?>
                <dl>
        ...
        <div class="main_02_itembox" id="main_02_item_6">
            <?
            $sql = "select * from ( select * , (SELECT COUNT(*) FROM g5_shop_item WHERE it_8 = m.it_id) AS cnt from {$g5['g5_shop_item_table']} m where it_use = '1' and ( ca_id like 'k0%' or ca_id2 like 'k0%' or ca_id3 like 'k0%' ) and it_8 ='' and it_type22 = '1' order by it_order, it_id desc ) a WHERE a.cnt > 0 limit 10 ";
            $res = sql_query($sql);
            for($i=0;$row = sql_fetch_array($res);$i++){ ?>
                <? $pri = sql_fetch("select it_price from {$g5['g5_shop_item_table']} where  it_use = '1' and it_8 = '{$row[it_id]}' order by it_price asc limit 1");?>
                <dl>
