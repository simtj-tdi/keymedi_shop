...
<div id="wrap">
    ...
    <style>
        ...
        #login_boxs .btn_submit2 { position: absolute; width: 100px; height: 90px;left: 265px;top: 124px; background:#2fa5ea; color:#fff;font-size:15px; font-weight: 700; border:0}
    ...
    <div id="login_wraps">
        <div style="width: calc(416px * 2);margin: 0 auto; border:2px solid #4a5f6f; border-radius: 22px;height: 490px">
                    ...
                    <div class="login_body">
                        ...
                        <form name="flogin" action="/bbs/login_check.php" onsubmit="return flogin_submit(this);" method="post">
                            ...
                            <fieldset id="login_fs">
                                ...
                                <div style="height:120px; ">   <input type="text" name="mb_id" id="login_id" required="" class="frm_input required" size="20" maxlength="20" value=""> <input type="text" name="mb_id" id="login_id" required="" class="frm_input required" size="20" maxlength="20" value=""><label class="clear">아이디</label>
                                    <input type="password" name="mb_password" id="login_pw" required="" class="frm_input required" size="20" maxlength="20"><label class="clear">비밀번호</label>
                                    <input type="button" value="로그인" class="btn_submit2"></div>
