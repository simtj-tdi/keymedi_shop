...
<div id="tail_wrap">
	...
	<div id="tail">
		<h1>고객센터<br>02-540-6393</h1>
		<address>
			<p>법인명:(주)키메디&nbsp;&nbsp;|&nbsp;&nbsp;서울시 강남구 논현로 416, 6층 운기빌딩(역삼동)&nbsp;&nbsp;|&nbsp;&nbsp;대표:김명진&nbsp;&nbsp;|&nbsp;&nbsp;사업자등록번호:388-81-00767</p>
			<p>팩스:02-6280-6393&nbsp;&nbsp;|&nbsp;&nbsp;이메일:keymedi@keymedi.com</p>
			<p>키메디 대표전화:02-540-0703&nbsp;&nbsp;|&nbsp;&nbsp;키메디몰 대표전화:02-540-6393&nbsp;&nbsp;|&nbsp;&nbsp;고객센터:09:00~18:00 운영(점심시간:12:30~13:30) 토,일,공휴일 휴무</p>
			<p>통신판매번호:제2017-서울강남-03514호&nbsp;&nbsp;|&nbsp;&nbsp;개인정보관리책임자:엄동일&nbsp;&nbsp;|&nbsp;&nbsp;메일:keymedi@keymedi.com&nbsp;&nbsp;|&nbsp;&nbsp;Copyrightⓒkeymedi All Right Reserved.</p>
		</address>
	</div>
</div>
...
<?php
if ($member['mb_type'] == '3' && $member['mb_level'] == '4' && $_COOKIE['intro_layer_popup'] != '1') {
?>

<style type="text/css">
#intro_layer_popup { position: fixed; z-index: 1000; top: 0px; width: 100%; height: 100%; }
#intro_layer_popup .bg { background: #000; opacity: 0.7; width: 100%; height: 100%; }
#intro_layer_popup > ul { width: 550px; position: absolute; top: 50%; left: 50%; margin: -215px 0 0 -275px; }
#intro_layer_popup > ul > li:first-child { text-align: right; font-size: 13px; padding: 5px 0; }
#intro_layer_popup > ul > li:first-child a { color: #fff; }
</style>

<div id="intro_layer_popup">
	<div class="bg"></div>
	<ul>
		<li><a href="javascript: void(0);" class="popup_close">일주일간 보지않기 ×</a></li>
		<li><a href="/introduce" target="_blank"><img src="/img/pop_1.jpg" /></a></li>
	</ul>
</div>

<script type="text/javascript">
$(document).ready(function() {
	$('#intro_layer_popup .popup_close').click(function() {
		set_cookie('intro_layer_popup', 1, (24 * 7), g5_cookie_domain);

		$('#intro_layer_popup').css({ 'display' : 'none' });
	});
});
</script>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-122992646-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date()); 
  gtag('set', {'user_id': '<?=$member[mb_id]?>' , 'title': '<?=$g5_head_title?>' }); // 로그인한 User-ID를 사용하여 User-ID를 설정합니다.
  gtag('config', 'UA-122992646-2');
</script>
